...
private:
    ...
    bool imu_valid_ = false, odom_valid_ = false;  
    ...
    std::deque<RotData> rot_container_;
    ...
    bool ComputeRotation(double pointTime, float *rotXCur, float *rotYCur, float *rotZCur);
